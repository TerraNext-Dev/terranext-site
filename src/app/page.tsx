			...
			<main className="flex-1">
				...
				<section id="quiz" className="border-t border-border">
					<div className="mx-auto max-w-6xl px-6 py-24">
						<div className="text-center mb-12">
							<h2 className="text-3xl sm:text-4xl font-bold tracking-tight">Is TerraNext right for you?</h2>
							<p className="mt-4 text-muted text-lg">Answer a few questions and find out.</p>
						</div>
						<Quiz />
					</div>
				</section>
				...
				<section id="comparison" className="border-t border-border">
					<div className="mx-auto max-w-7xl px-6 py-24">
						<div className="text-center">
							<h2 className="text-3xl sm:text-4xl font-bold tracking-tight">For your consideration</h2>
							<p className="mt-4 text-muted text-lg max-w-2xl mx-auto">It's always good to be honest.</p>
						</div>
						<div className="my-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
							{COMPARISONS.map((option) => (
								...
								>
									<h3 className={`text-lg font-semibold ${option.name === "TerraNext" ? "text-accent" : ""}`}>
										{option.name}
									</h3>
						...
						<div className="mt-16 max-w-3xl mx-auto space-y-12">
							<div>
								<div className="flex items-center gap-4 mb-5">
									<StepNumber n={1} />
									<h3 className="text-lg font-semibold">Build your Next.js app with OpenNext</h3>
								</div>
							...
							<div>
								<div className="flex items-center gap-4 mb-5">
									<StepNumber n={2} />
									<h3 className="text-lg font-semibold">Add TerraNext to your Terraform/OpenTofu</h3>
								</div>
				...
				<section className="border-t border-border">
					<div className="mx-auto max-w-6xl px-6 py-24 text-center">
						<h2 className="text-3xl sm:text-4xl font-bold tracking-tight">Ready to deploy?</h2>
			...
			<footer className="border-t border-border">
				<div className="mx-auto max-w-6xl px-6 py-10 text-sm text-muted">
					<div className="flex flex-col sm:flex-row items-center justify-between gap-4">
						<p>
							A project by{" "}
							<a href="https://oliverhardman.com" target="_blank" rel="noopener noreferrer">
								Oliver Hardman
							</a>
							.
						</p>
					...
					<div className="mt-4 text-xs text-left space-y-1">
						<p>
							...
							,{" "}
							<a href="https://opennext.js.org/" target="_blank" rel="noopener noreferrer">
								OpenNext
							</a>
							,{" "}
							<a href="https://www.hashicorp.com/" target="_blank" rel="noopener noreferrer">
								HashiCorp
							</a>{" "}
							or{" "}
						...
						<p>
							...
							<a href="https://lfprojects.org/" target="_blank" rel="noopener noreferrer">
								LF Projects
							</a>
							...
							. With thanks to{" "}
							<a href="https://github.com/nhsengland" target="_blank" rel="noopener noreferrer">
								NHS England
							</a>
							.
						</p>
